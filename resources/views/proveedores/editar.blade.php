...
@section('content')
    <div class="mx-auto py-4">
        ...
        <div class="mb-8 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-white uppercase tracking-tighter">Editar Proveedor</h1>
                <p class="text-blue-200/50 text-xs font-bold uppercase tracking-widest mt-0.5">{{ $proveedor->nombre }}</p>
            </div>
        </div>
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $proveedor->nombre) }}"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all uppercase font-bold" required>
                        </div>
                        <div>
                            <label for="rfc" class="block text-xs font-black text-blue-200/60 uppercase tracking-widest mb-2">RFC</label>
                            <input type="text" name="rfc" id="rfc" value="{{ old('rfc', $proveedor->rfc) }}"
                        ...
                        <div class="md:col-span-3">
                            ...
                            <input type="text" name="marcas_productos" id="marcas_productos" value="{{ old('marcas_productos', $proveedor->marcas_productos) }}"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all uppercase font-bold"
                        ...
                        <div class="md:col-span-3">
                            ...
                            <textarea name="direccion" id="direccion" rows="2"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all uppercase font-bold">{{ old('direccion', $proveedor->direccion) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="contacto_secundario" id="contacto_secundario" value="{{ old('contacto_secundario', $proveedor->contacto_secundario) }}"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all uppercase font-bold"
                                placeholder="NOMBRE COMPLETO">
                        </div>
                        <div>
                            ...
                            <input type="text" name="telefono_secundario" id="telefono_secundario" value="{{ old('telefono_secundario', $proveedor->telefono_secundario) }}"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all font-bold"
                                placeholder="55 1234 5678">
                        </div>
                        <div>
                            <label for="email_secundario" class="block text-xs font-black text-blue-200/60 uppercase tracking-widest mb-2">Email</label>
                            <input type="email" name="email_secundario" id="email_secundario" value="{{ old('email_secundario', $proveedor->email_secundario) }}"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all lowercase font-bold"
                ...
                <div class="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="number" name="dias_credito" id="dias_credito" value="{{ old('dias_credito', $proveedor->dias_credito) }}" min="0"
                        ...
                        <div class="md:col-span-3">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="3"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all uppercase font-bold"
                                placeholder="NOTAS INTERNAS SOBRE ESTE PROVEEDOR...">{{ old('observaciones', $proveedor->observaciones) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="banco" id="banco" value="{{ old('banco', $proveedor->banco) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="titular_cuenta" id="titular_cuenta" value="{{ old('titular_cuenta', $proveedor->titular_cuenta) }}"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all uppercase font-bold"
                        ...
                        <div>
                            ...
                            <input type="text" name="cuenta_bancaria" id="cuenta_bancaria" value="{{ old('cuenta_bancaria', $proveedor->cuenta_bancaria) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="clabe_interbancaria" id="clabe_interbancaria" value="{{ old('clabe_interbancaria', $proveedor->clabe_interbancaria) }}"
                                class="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-blue-200/20 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all font-mono font-bold tracking-widest"
