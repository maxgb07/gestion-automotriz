            ...
            <form action="{{ route('proveedores.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="dias_credito" id="dias_credito" value="{{ old('dias_credito', 0) }}" min="0" class="block w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-200/30 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all backdrop-blur-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="porcentaje_descuento_global" id="porcentaje_descuento_global" value="{{ old('porcentaje_descuento_global', 0.00) }}" min="0" max="100" class="block w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-200/30 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all backdrop-blur-sm">
                    </div>
