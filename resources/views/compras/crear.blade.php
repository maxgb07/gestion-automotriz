                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-center border-collapse" id="productos-table">
                            <thead class="bg-white/5 border-b border-white/10">
                                <tr>
                                    <th class="px-2 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest w-24">Cant</th>
                                    <th class="px-6 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest text-left">Producto</th>
                                    <th class="px-4 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest w-32">Precio Compra</th>
                                    <th class="px-4 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest w-32">Precio Venta</th>
                                    <th class="px-4 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest w-28">Global</th>
                                    <th class="px-4 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest w-28">Descuento Extra</th>
                                    <th class="px-4 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest w-28">Interno</th>
                                    <th class="px-4 py-4 text-xs font-semibold text-blue-200 uppercase tracking-widest w-36 text-right">Subtotal</th>
                        ...
                        <div class="flex flex-col items-end text-right space-y-2 w-full max-w-sm">
                            ...
                            <div class="flex flex-col gap-2 w-full mb-4 border-b border-white/10 pb-4">
                                <div class="flex flex-col w-full mb-3">
                                    <div class="flex justify-between items-center mb-1.5">
                                        ...
                                        <input type="number" step="any" name="monto_maniobra" id="monto_maniobra" value="0.00" oninput="calculateTotal()" onfocus="this.select()" class="w-32 px-3 py-1 bg-white/10 border border-white/20 rounded-lg text-white text-right focus:ring-2 focus:ring-blue-500 transition-all font-mono">
                                    </div>
                                    <div class="flex items-center">
                                        <label class="ios-switch-container group">
                                            <div class="ios-switch">
                                                <input type="checkbox" name="aplica_descuento_maniobra" id="aplica_descuento_maniobra" onchange="calculateTotal()">
                                ...
                                <div class="flex flex-col w-full">
                                    <div class="flex justify-between items-center mb-1.5">
                                        ...
                                        <input type="number" step="any" name="monto_seguro" id="monto_seguro" value="0.00" oninput="calculateTotal()" onfocus="this.select()" class="w-32 px-3 py-1 bg-white/10 border border-white/20 rounded-lg text-white text-right focus:ring-2 focus:ring-blue-500 transition-all font-mono">
                                    </div>
                                    <div class="flex items-center">
                                        <label class="ios-switch-container group">
                                            <div class="ios-switch">
                                                <input type="checkbox" name="aplica_descuento_seguro" id="aplica_descuento_seguro" onchange="calculateTotal()">
                                                <span class="ios-slider"></span>
                                            </div>
                                            <span class="ml-3 text-[10px] font-semibold text-blue-200/40 uppercase tracking-widest group-hover:text-blue-200 transition-colors">Aplica descuento</span>
                                        </label>
                            ...
                            <div class="flex justify-between items-center w-full pt-4 pb-4 border-b border-white/10">
                                ...
                                <div class="flex items-center gap-2">
                                    <input type="number" step="any" name="porcentaje_pronto_pago" id="porcentaje_pronto_pago" value="0.00" min="0" max="100" oninput="calculateTotal()" onfocus="this.select()" class="w-16 px-2 py-1 bg-white/10 border border-green-500/50 rounded-lg text-white text-right focus:ring-2 focus:ring-green-500 transition-all font-mono">
    ...
    <script>
        $(document).ready(function() {
            ...
            window.calculateTotal = function() {
                ...
                document.querySelectorAll('tr[class*="hover:bg-white/5"]').forEach(row => {
