                        ...
                        <div class="flex flex-col items-end text-right space-y-2 w-full max-w-sm">
                            ...
                            <div class="flex flex-col gap-2 w-full mb-4 border-b border-white/10 pb-4">
                                <div class="flex justify-between items-center w-full">
                                    ...
                                    <input type="number" step="any" name="monto_maniobra" id="monto_maniobra" value="0.00" oninput="calculateTotal()" class="w-32 px-3 py-1 bg-white/10 border border-white/20 rounded-lg text-white text-right focus:ring-2 focus:ring-blue-500 transition-all font-mono">
                                </div>
                                <div class="flex justify-between items-center w-full">
                                    <span class="text-blue-200 text-xs uppercase font-bold">Costo de Seguro</span>
                                    <input type="number" step="any" name="monto_seguro" id="monto_seguro" value="0.00" oninput="calculateTotal()" class="w-32 px-3 py-1 bg-white/10 border border-white/20 rounded-lg text-white text-right focus:ring-2 focus:ring-blue-500 transition-all font-mono">
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            window.calculateTotal = function() {
                ...
                // 3. Interno (Productos)
                // Se aplica sobre el remanente proporcional de cada fila
