                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-center border-collapse" id="productos-table">
                            <thead class="bg-white/5 border-b border-white/10">
                                <tr>
                                    <th class="px-2 py-4 text-md font-bold text-blue-200 uppercase tracking-widest w-24">Cant</th>
                                    <th class="px-6 py-4 text-md font-bold text-blue-200 uppercase tracking-widest text-left">Producto</th>
                                    <th class="px-4 py-4 text-md font-bold text-blue-200 uppercase tracking-widest w-32">Precio Compra</th>
                                    <th class="px-4 py-4 text-md font-bold text-blue-200 uppercase tracking-widest w-32">Precio Venta</th>
                                    <th class="px-4 py-4 text-md font-bold text-blue-200 uppercase tracking-widest w-28">Descuento 1</th>
                                    <th class="px-4 py-4 text-md font-bold text-blue-200 uppercase tracking-widest w-28">Descuento 2</th>
                                    <th class="px-4 py-4 text-md font-bold text-blue-200 uppercase tracking-widest w-28">Interno</th>
                                    <th class="px-4 py-4 text-md font-bold text-blue-200 uppercase tracking-widest w-36 text-right">Subtotal</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#proveedor_id').select2({
                ...
                $('.row-desc1').val(descGlobal);
                $('.row-desc2').val(descExtra);
