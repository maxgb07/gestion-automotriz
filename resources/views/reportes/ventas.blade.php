...
<div class="mx-auto py-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start mb-8 gap-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-white uppercase tracking-tighter">Reporte de Ventas</h1>
        ...
        <a href="{{ route('reportes.ventas.pdf', ['fecha_inicio' => $fecha_inicio, 'fecha_fin' => $fecha_fin]) }}" target="_blank" class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-black rounded-xl transition-all uppercase tracking-widest shadow-lg shadow-blue-900/30">
