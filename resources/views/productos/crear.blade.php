...
@section('content')
    <div class="mx-auto py-4">
        <div class="mb-8 flex items-center justify-between">
            ...
            <h1 class="text-3xl font-bold text-white uppercase tracking-tight">Nuevo Producto</h1>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea name="aplicacion" id="aplicacion" rows="4" class="block w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-200/30 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all backdrop-blur-sm uppercase" placeholder="EJ: NISSAN TSURU III, VW SEDAN...">{{ old('aplicacion') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative group h-[116px]">
                                ...
                                <div id="image-placeholder" class="w-full h-full bg-white/10 border-2 border-dashed border-white/20 rounded-xl flex flex-col items-center justify-center group-hover:bg-white/20 group-hover:border-blue-500/50 transition-all backdrop-blur-sm overflow-hidden">
                                    ...
                                    <div id="upload-icon" class="flex flex-col items-center">
                                        ...
                                        <span class="text-xs text-blue-200 uppercase">Subir Imagen</span>
                                    </div>
                                </div>
                            </div>
                        </div>
